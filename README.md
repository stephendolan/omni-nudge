...
# You'll be prompted for your work calendar name for meeting detection
./install-cron.sh
```
...
**Change meeting calendar**: Run `./uninstall-cron.sh` then `./install-cron.sh` with new calendar name
